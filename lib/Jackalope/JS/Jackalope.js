...
Jackalope.Schema.Validator.Core.prototype = {
    ...
    "object" : function ( schema, data ) {
        ...
        var has_properties            = this.utilities.key_count(schema["__compiled_properties"]) != 0;
        var has_additional_properties = this.utilities.key_count(schema["__compiled_additional_properties"]) != 0;
        ...
        if (has_properties || has_additional_properties) {
            if (this.utilities.key_count( all_props ) != 0)
                return {
