...
Jackalope.Client.View.Panel = function ( opts ) {
    ...
    this.$panel   = jQuery( this.element );
...
Jackalope.Client.View.Panel.prototype.show = function () { this.$panel.show() };
Jackalope.Client.View.Panel.prototype.hide = function () { this.$panel.hide() };