...
Jackalope.Client.Binding.prototype = {
    "init" : function ( opts ) {
        ...
        if (opts["target"]        == undefined) throw new Jackalope.Error ("'target' is required");
    ...
    "setup" : function () {
        ...
        this.update_element( this.target, this.get_target_value() );
    },
    // element handlers
    ...
    // target handlers
    "register_target_event" : function ( e ) {
        this.target.bind( "update:" + this.property, e );
    },
    ...
    "set_target_value" : function ( value ) {
        ...
        return this.target.set( changes );
    },
    // default events
