    ...
    "_flatten_extends" : function ( schema, schema_map ) {
        ...
        if ( schema.raw["extends"] != undefined && this._is_ref( schema.raw["extends"] )) {
            ...
            if (super_schema == undefined)
                throw new Jackalope.Error ("Could not find schema for " + schema.raw["extends"]["$ref"]);
            this._merge_schema(
                schema,
                super_schema,
                schema_map
    ...
    "_merge_schema" : function ( schema, super_schema, schema_map ) {
        ...
        if ( super_schema.raw["extends"] != undefined && this._is_ref( super_schema.raw["extends"] ) ) {
            ...
            if (super_super_schema == undefined)
                throw new Jackalope.Error ("Could not find schema for " + super_schema.raw["extends"]["$ref"]);
            this._merge_schema(
                schema,
                super_super_schema,
                schema_map
            ...
            for (var p in obj) {
                ...
                if (Jackalope.Util.is_object( v )) {
                    if ( v["extends"] != undefined && self._is_ref( v["extends"] ) ) {
                        ...
                        if (super_schema == undefined)
                            throw new Jackalope.Error ("Could not find schema for " + v["extends"]["$ref"]);
                        self._merge_schema(
                            embedded_schema,
                            super_schema,
                            new_schema_map
